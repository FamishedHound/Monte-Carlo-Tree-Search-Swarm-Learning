...
//            }
    ...
    public void calculateDistance(){
        // the key of the entrySet is the "team"
        //observations generated by observe() which copies the state of the defenders
        //for a certain number of frames before clearing
...
//                        }
    ...
    public void learnTheErrors(Map<Integer,ArrayList<WeightedObservedPoint>> map,int mode,ArrayList<BoidGeneric> defenders ){
        ...
        // howManyErrors is a constant field of 20 which seems very low for a decent estimation
            ...
            for (int i = 0; i < frameCount; i++) {
                ...
                for (BoidGeneric def : simulationBoids) {
                    ...
                    if(i==frameCount-1) {
                        ...
                        //endPositions are positions of real boids. they are calculated via calculateDistance
