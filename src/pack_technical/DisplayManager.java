...
public class DisplayManager {
    ...
    void draw_selected_boid() {
        if(GameManager.selected_boid != null) {
            highlight_boid(GameManager.selected_boid, SELECTVISUALRADIUS);
    ...
    void draw_base() {
        parent.fill(255,0,0);
        parent.rect(Constants.TARGET.x, Constants.TARGET.y,10f,10f);

        // different edges Triangle
        parent.fill(105,105,105);
        parent.line(450,800,850,500);
        parent.line(850,500,450,100);
        parent.line(450,100,450,800);
    }
